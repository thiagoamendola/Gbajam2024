    ...
    constexpr inline face_3d asteroid1_faces_full[] = {
        ...
        face_3d(asteroid1_vertices, vertex_3d(0.0148,0.9984,0.0546),0,1,2,0,4),
        face_3d(asteroid1_vertices, vertex_3d(0.2512,-0.2857,0.9248),3,0,2,0,3),
        face_3d(asteroid1_vertices, vertex_3d(-0.5309,-0.6031,-0.5953),1,4,3,0,1),
