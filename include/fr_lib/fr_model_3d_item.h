...
namespace fr
{
    ...
    public:
        ...
        constexpr face_3d(const bn::span<const vertex_3d> &vertices, const vertex_3d &normal, int first_vertex_index,
                          int second_vertex_index, int third_vertex_index, int color_index, int shading) : _centroid(_calculate_centroid(vertices, first_vertex_index, second_vertex_index, third_vertex_index)),
                                                                                                           _normal(normal),
        ...
        constexpr face_3d(const bn::span<const vertex_3d> &vertices, const vertex_3d &normal, int first_vertex_index,
                          ...
                          int shading) : _centroid(_calculate_centroid(vertices, first_vertex_index, second_vertex_index, third_vertex_index,
                                                                       fourth_vertex_index)),
                                         _normal(normal),
                                         _first_vertex_index(first_vertex_index),
                                         _second_vertex_index(second_vertex_index),
    ...
    public:
        ...
        constexpr model_3d_vertical_cylinder(bn::fixed centroid_x, bn::fixed centroid_z, int integer_radius) : _centroid_x(centroid_x),
    ...
    public:
        constexpr model_3d_item(const bn::span<const vertex_3d> &vertices, const bn::span<const face_3d> &faces) : model_3d_item(vertices, faces, nullptr, nullptr)
        {
        }

        constexpr model_3d_item(const bn::span<const vertex_3d> &vertices, const bn::span<const face_3d> &faces,
                                const face_3d *collision_face) : model_3d_item(vertices, faces, collision_face, nullptr)
        {
        }

        constexpr model_3d_item(const bn::span<const vertex_3d> &vertices, const bn::span<const face_3d> &faces,
                                const face_3d *collision_face, const model_3d_vertical_cylinder *vertical_cylinder) : _vertices(vertices),
                                                                                                                      _faces(faces),
    ...
    public:
        constexpr face_texture(
            ...
            const bn::sprite_tiles_item &huge_tiles_item) : _palette_item(palette_item),
