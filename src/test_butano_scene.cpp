...
test_butano_scene::test_butano_scene() : _bgs_fade_in_action(bn::bg_palettes_fade_to_action(1, 0)),
                                         _controller_spr(bn::sprite_items::controller.create_sprite(0, 0)),
                                         _horizontal_position_hbe(bn::sprite_position_hbe_ptr::create_horizontal(_controller_spr, _horizontal_deltas)),
                                         ...
                                         _floor_bg(bn::regular_bg_items::floor.create_bg(0, 0))
{
    ...
    text_generator.generate(-6 * 16, -68, "Hello I'm some text yey", _text_sprites);
...
void test_butano_scene::arrow_update()
{
    ...
    {
        _arrow_spr.set_tiles(bn::sprite_items::arrow.tiles_item().create_tiles(2));
    }
    else if (bn::keypad::right_held())
    {
        _arrow_spr.set_tiles(bn::sprite_items::arrow.tiles_item().create_tiles(3));
    }

    if (bn::keypad::up_held())
    {
        _arrow_spr.set_tiles(bn::sprite_items::arrow.tiles_item().create_tiles(0));
    }
    else if (bn::keypad::down_held())
    {
        _arrow_spr.set_tiles(bn::sprite_items::arrow.tiles_item().create_tiles(1));
    }
}
...
void test_butano_scene::ninja_update()
{
    ...
    {
        _ninja_action = bn::create_sprite_animate_action_forever(
            _ninja_spr, 16, bn::sprite_items::ninja.tiles_item(), 12, 13, 14, 15);
    }
